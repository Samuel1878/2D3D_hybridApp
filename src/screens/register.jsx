...
import styles, { app_1, bg_1, bg_5 } from "../libs/style";
        ...
        <View style={styles.RegScreenCon}>
          ...
          >
            ...
            <Text style={styles.inputLabel}>
              Phone:{" "}
              {validNo || phone === "" ? (
                <AntDesign name="check" size={18} color={app_1} />
              ) : (
                <AntDesign name="exclamation" size={18} color={app_1} />
              )}
            </Text>
            <TextInput
              ...
              style={[
                styles.regNo,
                { borderColor: state.phoneFocused ? app_1 : bg_1 },
              ]}
              value={phone}
              inputMode="tel"
              placeholder="09...123..."
            ...
            <View style={styles.reg2FaBox}>
              <TextInput
                ...
                style={[
                  styles.regInput2Fa,
                  { borderColor: state.otpFocused ? app_1 : bg_1 },
                ]}
                value={OTP}
            ...
            <Text style={styles.inputLabel}>
              ...
              {!validPwd && password !== "" ? (
                <>
                  <AntDesign name="exclamation" size={14} color={bg_5} />
            ...
            <TextInput
              ...
              style={[
                styles.regPwd,
                { borderColor: state.pwdFocused ? app_1 : bg_1 },
              ]}
              value={password}
            ...
            <TextInput
              ...
              style={[
                styles.regPwd,
                { borderColor: state.pwd2Focused ? app_1 : bg_1 },
              ]}
              value={comPwd}
